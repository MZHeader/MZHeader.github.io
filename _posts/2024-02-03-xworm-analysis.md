...
![obfuscated batch script with many set variable assignments and commented-out strings](/assets/img/15a2ff27-e269-40d7-96fc-586d9093245b.png)
...
![end of batch script showing variable concatenation and execution](/assets/img/56b8f863-19b1-42db-951a-7bfcd968584e.png)
...
![modified batch script with echo commands added before variable execution](/assets/img/be36953d-e183-4e48-9ff8-f861c071a512.png)
...
![batch script showing the ::@ prefixed base64 encoded AES-encrypted blob](/assets/img/d8d60598-7491-4893-8892-2d4d563c8206.png)
...
![CyberChef recipe removing underscores, base64 decoding, AES-CBC decrypting, and gunzipping the blob](/assets/img/d45309f5-a055-4251-b051-96766c3050b3.png)

We are left with an executable file.

![CyberChef output showing MZ header of decrypted .NET executable](/assets/img/0b251516-6528-43ff-b54a-ced8d90e169f.png)
...
![Detect It Easy showing .NET binary with moderate entropy suggesting a loader](/assets/img/c6ef6c1c-b1dd-4fdc-85d8-f9a6ed669266.png)
...
![DNSpy showing heavily obfuscated .NET binary with LoadPE reference indicating a loader](/assets/img/23ac0071-6c6b-4f02-b400-45a40b3ab74e.png)
...
![DNSpy module breakpoints dialog with wildcard breakpoint set for all modules](/assets/img/31865716-bb47-45d9-aabb-332c2cc0f323.png)
...
![DNSpy debugger showing a suspicious unnamed module being loaded in memory](/assets/img/b4c94a3e-5255-4d35-b37c-b36ba64ba74e.png)
...
![DNSpy decompiling the unobfuscated second-stage module showing Settings class](/assets/img/9e5f87ea-7e84-4d94-8ad4-16fef0a92b75.png)

**Settings:**

![DNSpy showing XWorm configuration settings including C2 IP address](/assets/img/9b67b4f1-e3a9-4684-9cc1-009723118aff.png)
