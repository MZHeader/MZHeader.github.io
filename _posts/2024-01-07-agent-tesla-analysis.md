...
Further investigation of network traffic shows that POST requests are made towards the Telegram API domain, a strong indication that this sensitive information is being exfiltrated via Telegram C2.
