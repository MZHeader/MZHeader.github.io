...
The game was taken down from the Steam marketplace, but the change history can be found here: [SteamDB Change History](https://steamdb.info/app/3476470/history/)
...
![SteamDB changelist 27351505 showing embedded VBS script added to PirateFi game files](/assets/img/2026-03-15%2013_30_44-Desktop%20-%20File%20Explorer.png)
...
![WinDbg breakpoint on VirtualAlloc indirect call in Howard.exe at return address 02BA0000](/assets/img/Untitled%203.png)
...
![WinDbg memory write breakpoint at 02BA0000 showing payload being written in a loop](/assets/img/Screenshot%202026-03-15%20at%2014.25.07.png)
...
![WinDbg memory view showing MZ header magic bytes at start of allocated buffer in Howard.exe](/assets/img/Screenshot%202026-03-15%20at%2014.28.13.png)
...
static byte[] smethod_14() {
    byte[] emyrsqaglox = Class1.Emyrsqaglox;
    // return (byte[])Class1.Cazmb.GetObject("Reydbozimwj", Class1.cultureInfo_0);
    byte[] array;
    using (Aes aes = Aes.Create()) {
        aes.KeySize = 256;
        aes.Key = Convert.FromBase64String(Class0.string_0);
        // string_0 = UlPs+RiNkeAQjtjBHi2FZme93GOwtujN9g03qBhA2xM=
        aes.IV = Convert.FromBase64String(Class0.string_1);
        // string_1 = 8VSGg0PMrhcl1gUkFwmUlg==
...
![DNSpy Locals window showing MZ header byte array 4D 5A in decrypted payload at return array3 breakpoint](/assets/img/Screenshot%202026-03-15%20175824.png)
...
![DNSpy Watch window showing decrypted Vidar string table loaded from hashtable at runtime](/assets/img/Hashtable3.png)
...
![Web Archive snapshot from Feb 2025 showing Vidar C2 IP 95.216.180.186 on Steam dead-drop profile](/assets/img/Screenshot%202026-03-15%20at%2018.51.52.png)
